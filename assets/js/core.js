...
export const elements = {
    ...
    adminTopbarTitle: document.querySelector("#adminTopbarTitle"),
    adminTopbarSubtitle: document.querySelector("#adminTopbarSubtitle"),
    adminTopbarMenuButton: document.querySelector("#adminTopbarMenuButton"),
    ...
    adminQuickRole: document.querySelector("#adminQuickRole"),
